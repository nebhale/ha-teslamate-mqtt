...
def _state(hass: HomeAssistant, entity_id: str) -> State:
    """Return the state for an entity that must exist."""
...
def _entity_entry(
    ...
    """Return the registry entry for an entity that must exist."""
...
def _device_entry(
    ...
    """Return the registry entry for a device that must exist."""
...
async def test_entities(
    ...
    device = _device_entry(device_registry, {(DOMAIN, "teslamate/cars/1")})
